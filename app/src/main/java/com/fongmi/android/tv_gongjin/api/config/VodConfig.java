package com.fongmi.android.tv_gongjin.api.config;

import android.text.TextUtils;

import com.fongmi.android.tv_gongjin.api.loader.JarLoader;
import com.fongmi.android.tv_gongjin.api.loader.JsLoader;
import com.fongmi.android.tv_gongjin.api.loader.PyLoader;
import com.fongmi.android.tv_gongjin.bean.Config;
import com.fongmi.android.tv_gongjin.bean.Depot;
import com.fongmi.android.tv_gongjin.bean.Parse;
import com.fongmi.android.tv_gongjin.bean.Rule;
...
import com.fongmi.android.tv_gongjin.api.Decoder;
...
public class VodConfig {
    ...
    private void loadConfig(Callback callback) {
        try {
            App.post(() -> callback.error("插兜的干货仓库: 本软件为免费开源项目, 如有广告均为三方提供, 请勿相信!"));
