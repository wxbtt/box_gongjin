...
public class CastDevice {
    ...
    public List<com.fongmi.android.tv_gongjin.bean.Device> getAll() {
        List<com.fongmi.android.tv_gongjin.bean.Device> items = new ArrayList<>();
        for (org.fourthline.cling.model.meta.Device<?, ?, ?> item : devices) items.add(create(item));
        return items;
    }

    public List<com.fongmi.android.tv_gongjin.bean.Device> add(org.fourthline.cling.model.meta.Device<?, ?, ?> item) {
        devices.remove(item);
        devices.add(item);
        return getAll();
    }
    ...
    public org.fourthline.cling.model.meta.Device<?, ?, ?> find(com.fongmi.android.tv_gongjin.bean.Device item) {
